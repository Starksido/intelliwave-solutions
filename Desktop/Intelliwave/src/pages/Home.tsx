	...
	return (
		<div>
			...
			<section className="hero full-bleed">
				...
				<div className="container hero-content" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 20 }}>
					<h1 className="fade-in">Transform data into intelligent outcomes</h1>
					<p className="fade-in delay-1" style={{ color: '#0a0a0a' }}>
						We harden and modernize your stack — surveillance, cybersecurity, cloud, and networks —
						with automation and measurable KPIs.
					</p>
					<div className="cta-row fade-in delay-2" style={{ marginTop: 8 }}>
						<Link className="button primary" to="/contact">For Consultation</Link>
						<Link className="button" to="/founders">Meet the Founders</Link>
					</div>
					<div className="badges fade-in delay-3" style={{ marginTop: 12 }}>
			...
			<section style={{ marginTop: 28 }}>
				<div className="bubbles">
					<Link to="/services" className="bubble" style={{ textDecoration: 'none' }}>
